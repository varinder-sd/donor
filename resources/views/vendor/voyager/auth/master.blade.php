...
<head>
    ...
    <style>
        ...
        body.login .login-sidebar {
            border-top:5px solid {{ config('voyager.primary_color','#9a0d0d') }};
        }
        ...
        body.login .form-group-default.focused{
            border-color:{{ config('voyager.primary_color','#9a0d0d') }};
        }
        .login-button, .bar:before, .bar:after{
            background:{{ config('voyager.primary_color','#9a0d0d') }};
        }
        .remember-me-text{
            padding:0 5px;
        }
